           ...
           <ul _ngcontent-c12="" class="box-products-items">
                <li _ngcontent-c23="" class="vertical-item box-line" v-for="k in list">
                    ...
                    <div _ngcontent-c23="" class="box-item-content">
                        ...
                        <div _ngcontent-c23="" class="attr-container"> <!---->
                            <ul _ngcontent-c23="" class="style-label"> <!---->
                                <li _ngcontent-c23="" class="box-border"> 
                                <span _ngcontent-c23="">4G + 32GB</span> 
                                </li>
                                <li _ngcontent-c23="" class="box-border"> 
                                    <span _ngcontent-c23="">4G + 64GB</span> 
                                </li>
                                <li _ngcontent-c23="" class="box-border">
                                    <span _ngcontent-c23="">6G + 64GB</span> 
                                </li>
                                <li _ngcontent-c23="" class="box-border"> 
                                    <span _ngcontent-c23="">6G + 128GB</span> 
                                </li>
                                <li _ngcontent-c23="" class="box-border"> 
                                    <span _ngcontent-c23="">6G + 256GB</span> 
                                </li> 
                            </ul> <!----> <!----> <!---->
                            <ul _ngcontent-c23="" class="color-switch"> <!---->
                                <li _ngcontent-c23=""> 
                                    <div _ngcontent-c23="" class="outer"> 
                                        <span _ngcontent-c23="" style="background-image: url(&quot;https://resource.smartisan.com/resource/attr/v2/1000351/6CF45CDABAF3B549B82C10A50BDBEF39/origin.png&quot;); background-repeat: no-repeat; background-position: center center; background-size: contain;"></span> 
                                    </div> 
                                </li>
                                <li _ngcontent-c23=""> 
                                    <div _ngcontent-c23="" class="outer">
                                        <span _ngcontent-c23="" style="background-image: url(&quot;https://resource.smartisan.com/resource/attr/v2/1000351/97BBF007C06CF961411BC376A98C586D/origin.png&quot;); background-repeat: no-repeat; background-position: center center; background-size: contain;"></span> 
                                        </div> 
                                </li>
                                <li _ngcontent-c23="">
                                    <div _ngcontent-c23="" class="outer"> 
                                        <span _ngcontent-c23="" style="background-image: url(&quot;https://resource.smartisan.com/resource/attr/v2/1000351/6835AD084B4CE188877FFAFA10339944/origin.png&quot;); background-repeat: no-repeat; background-position: center center; background-size: contain;"></span> 
                                    </div> 
                                </li>
                                <li _ngcontent-c23=""> 
                                    <div _ngcontent-c23="" class="outer"> 
                                        <span _ngcontent-c23="" style="background-image: url(&quot;https://resource.smartisan.com/resource/e647e77234f9ed0fde9dd4084d35ff57.jpg&quot;); background-repeat: no-repeat; background-position: center center; background-size: contain;"></span> 
                                    </div> 
                                </li> 
                            </ul> 
                        </div> 
                        <div _ngcontent-c23="" class="price-container"> 
                            <p _ngcontent-c22="" class="price"> 
                                <i _ngcontent-c22="">¥</i> 
                                <span _ngcontent-c22="" class="pie" v-text="k.pie"></span> <!---->
                            </p>  
                        </div> 
                    </div> 
                </li>
